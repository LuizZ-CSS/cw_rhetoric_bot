...
function App() {
    ...
    const [alignment, setAlignment] = useState(2); // 0: pro-NATO, 1: slightly pro-USA, 2: neutral, 3: slightly pro-USSR, 4: pro-USSR
    const [sceneStyle, setSceneStyle] = useState(0); // 0: interview, 1: diplomatic dinner, 2: classroom, 3: street conversation, 4: private letter

    // const alignmentLabels = ["Pro-NATO", "Slightly Pro-USA", "Neutral", "Slightly Pro-USSR", "Pro-USSR"];
    ...
    <div>
        ...
        {["Strongly pro-NATO", "Slightly pro-NATO", "Neutral", "Slightly pro-USSR", "Strongly pro-USSR"].map((label, idx) => (
    ...
    <div>
        ...
        {["Interview", "Diplomatic Dinner", "Classroom", "Street Conversation", "Private Letter"].map((label, idx) => (
            <label key={idx} style={{ display: "inline-block", marginRight: "20px" }}>
                <input
                    type="radio"
                    name="scene"
